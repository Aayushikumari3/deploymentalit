        ...
        <div className='landingPage'>
            ...
            <footer className="footer wf-section">
                ...
                <div className="container footer w-container">
                    ...
                    <div className="w-layout-grid grid-three">
                        <div>
                            <div>Aayushi the doctor</div>
                        </div>

                        <div>
                            <a href="tel:(+91) 9382707074" className="footer-link">‭(+91) 4566214896</a>
                            <a href="mailto: aayushikumariasansol2004@gmail.com"
                                className="footer-link">hello@mindwaves.live</a>
                        </div>
                        <div>© mindwaves<br />IIT ISM DHANBAD</div>
                    </div>
                </div>
            </footer>
        </div>
